...
$tok ="148103344:AAEbtbhfqjtj-vGaDnmntxUn7Pm4eysTn90";
...
switch($message){
 ...
 case "Location":
     if($c == 4 && $location){
        ...
        sendMessage($chatId,urlencode("Thanks for subscribing, we will keep you notified with the property news in your area. \n\n To change the region of interest just send new location.".$c));
     }else{
