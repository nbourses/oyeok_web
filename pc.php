	           	...
	           	<form id="to_send_otp" class="form-vertical">
	        		<fieldset>
	        			<div class="form-group">
	        			  ...
	        			  <div class="col-lg-10">
	        			    <input type="tel" class="form-control" id="phone_no" placeholder="Phone Number (10 digits)" name="phone_no" pattern="[789][0-9]{9}" required min="7000000000" max="9999999999">
